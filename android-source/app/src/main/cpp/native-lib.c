...
Java_app_nukera_core_NukeraProxy_jniStartProxy(JNIEnv *env, __attribute__((unused)) jobject thiz, jobjectArray args) {
    if (g_proxy_running) {
...
JNIEXPORT jint JNICALL
Java_app_nukera_core_NukeraProxy_jniStopProxy(__attribute__((unused)) JNIEnv *env, __attribute__((unused)) jobject thiz) {
...
JNIEXPORT jint JNICALL
Java_app_nukera_core_NukeraProxy_jniForceClose(__attribute__((unused)) JNIEnv *env, __attribute__((unused)) jobject thiz) {
