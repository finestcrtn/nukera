...
import app.nukera.R
import app.nukera.data.AppSettings
import app.nukera.fragments.NukeraCMDSettingsFragment
import app.nukera.fragments.NukeraUISettingsFragment
import app.nukera.fragments.MainSettingsFragment
import app.nukera.utility.SettingsUtils
import app.nukera.utility.SettingsUtils.Section
import java.io.File
            ...
            when (openFragment) {
                "cmd" -> {
                    supportFragmentManager
                        .beginTransaction()
                        .replace(R.id.settings, NukeraCMDSettingsFragment())
                        .commit()
                }
                "ui" -> {
                    supportFragmentManager
                        .beginTransaction()
                        .replace(R.id.settings, NukeraUISettingsFragment())
                        .commit()
                }
                else -> {
                    supportFragmentManager
