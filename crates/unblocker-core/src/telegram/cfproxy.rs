use super::config::*;
use super::ws::{is_http_status_error, ws_connect_once, RawWebSocket, WsError};
...
pub fn init_cfproxy_domains() {
    ...
    if !cfg.user_domain.is_empty() {
        ...
        super::balancer::BALANCER.write().update_domains_list(&cfg.domains);
        return;
    }
...
pub async fn try_refresh_cfproxy_domains() -> bool {
    ...
    if !new_domains.is_empty() {
        ...
        super::balancer::BALANCER.write().update_domains_list(&merged);
...
pub async fn cf_connect_domain(
    ...
    let attempt_timeout = super::ws::ws_connect_timeout(timeout);
