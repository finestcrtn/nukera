...
Nukera — GUI приложение на основе принципов Zapret и других способовв обхода, собранных так, чтобы разблокировать **Instagram, Telegram, YouTube, Discord и все остальные** заблокированные сайты, даже те, которые другие варианты Zapret разблокировать не могут. При этом не требует ручной настройки: Включил — работает.
